...
const OutstandingInstForm: FormEntry[] = [
    ...
    {
        title: "Q2. State the awards/certifications received from various national and international accrediting agencies such as AACSB, NAAC, NBA, Govt. Grading, School boards and Govt. agencies. (500 words only)",
        name: "q_02",
        type: "textarea",
        validator: v.q_02,
        required: true,
    ...
    {
        title: "Q31. State any Consultancy projects undertaken for Corporate or Government (300 words only)",
        type: "textarea",
        required: true,
        name: "q_31",
        validator: v.q_31,
